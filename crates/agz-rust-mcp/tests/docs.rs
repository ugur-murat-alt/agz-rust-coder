...
use agz_rust_mcp::workspace::{AuthorizedRoot, RootGuard};
...
fn selected_child_replacement_rejects_local_doc_generation_before_cargo_runs() {
    ...
    use agz_rust_mcp::workspace::ClientRoots;
    ...
    let result =
        agz_rust_mcp::docs::CargoDocGenerator::default().generate_authorized(&request, authority);
